...
@section('contenido')
    <div class="px-8 mt-5 pt-8 ">
        ...
        <div class="flex justify-between  flex-col gap-2 md:flex-row  mb-5">
            <h1 class="text-4xl font-bold text-dark">Gestión de lista de inspección Polar</h1>

            <a class="btn btn-primary " role="button" href="{{ route('listaChequeoPolar.create') }}">Crear inspección
                Polar</a>
        </div>
        ...
        @endif
        <livewire:lista-chequeo-polar.show />
    </div>
@endsection
