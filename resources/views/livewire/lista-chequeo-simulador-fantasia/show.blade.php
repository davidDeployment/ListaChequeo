    ...
    <table id="example" class="stripe hover " style="padding-top: 1em;  padding-bottom: 1em;">
        <thead>
            <tr class="bg-slate-700 bg-opacity-100 text-white">
                ...
                <th data-priority="5">Perimetro: verificar que no haya fisuras, roturas en la paredes, reja del compresor
                    sin daños y cerrada con candado, cerramiento debidamente ubicado de los aires acondicionados.
                </th>
                <th data-priority="6">
                    Enfiladeros: verificar que los postes esten firmes, tornilleria completa, soldadura y pintura en
                    buen estado
                </th>
                <th data-priority="7">
                    Verificar la ausencia de elementos extraños en la zona, escombros, basuras.
                </th>
                <th data-priority="8">
                    Revisar que las láminas se encuentran ajustadas con sus respectivos dispositivos de sujeción y están
                    correctamente ubicadas.
                </th>
                <th data-priority="9">
                    Revisar las puertas y seguros funcionando
                </th>
                <th data-priority="10">
                    Revise que los avisos están bien colocados en su lugar (entrada y salida)
                </th>
                <th data-priority="11">
                    Verificar que las paredes de la estructura estén correctamente ancladas, firmes y completas en su
                    sitio, sin agujeros ni fisuras.
                </th>
                <th data-priority="12">
                    Revisar que no halla ingreso de agua desde el techo o desde el piso.
                </th>
                <th data-priority="13">
                    Inspeccionar buen estado de las juntas soldadas en platinas y las horquillas de soporte en los
                    actuadores, las cuales no deben tener fisuras.
                </th>
                <th data-priority="14">
                    Verificar buen estado estructural de la silla y el ajuste de los tornillos en platina y horquillas
                </th>
                <th data-priority="15">
                    Verificar las salidas de agua y aire se encuentren sin obstrucción
                </th>
                <th data-priority="16">
                    Revisar el buen estado de la cojinería, tapizado y cinturones de cada silla
                </th>
                <th data-priority="17">
                    Revisar que las mangueras se encuentren posicionadas de manera adecauda
                </th>
                <th data-priority="18">
                    Abrir valvulas de los dos tanques acumuladores para permitir la salida de humedad.
                </th>
                <th data-priority="19">
                    Revisar el compresor, que no tenga obstrucción en la succión y la salida de aire y desactivar el
                    paro de emergencia, verificar presiones a 6Bar.
                </th>
                <th data-priority="20">
                    Revisar que cada actuador este bien sujeto a cada silla y al piso, racores y manquegras instaladas,
                    que el vástago del piston no presente fisuras y/o deformaciones.
                </th>
                <th data-priority="21">
                    Revisar nivel de aceite del compresor, en caso de adicionar usar aceite Kerry 8000
                </th>
                <th data-priority="22">
                    Revisar el buen estado de los racores y mangueras instaladas, que el vástago del piston no presente
                    fisuras y/o deformaciones.
                </th>
                <th data-priority="23">
                    Verificar la impermeabilidad del Rack, que no halla objetos extraños.
                </th>
                <th data-priority="24">
                    Revisar que los elementos eléctricos estén completos y conectados en sus respectivas borneras y
                    cajas electricas.
                </th>
                <th data-priority="25">
                    Verificar que no haya evidencia de cortos, cintas aislantes sueltas, o indicios de recalentamiento
                    en los componentes del Rack etablero.
                </th>
                <th data-priority="26">
                    Verificar que el computador esté apagado, no presente humedades al regulador o al Rack.
                </th>
                <th data-priority="27">
                    Verifique buen estado del teclado, pantalla y del mouse
                </th>
                <th data-priority="28">
                    Poner el swiche principal en ON y los breakets de control.
                </th>
                <th data-priority="29">
                    Ir al compresor verificando que el pulsador de paro de emergencia esté desactivado y resetearlo en
                    0, contar 3 segundos y presionar ON en I, debe llegar a presión 7BAR
                </th>
                <th data-priority="30">
                    Revisar funcionamiento de maquinas de simulación (maquina de burbujas, maquina de humo, aires
                    acondicionados)
                </th>
                <th data-priority="31">
                    Ponga en marcha la atracción haciendo uso de la pantalla el teclado y el mouse si este lo presenta.
                </th>
                <th data-priority="32">
                    Se debe hacer al menos un ciclo completo e ir verificando que los movimientos de las sillas
                    concuerden con la simulación, al igual que cada accesorio de simulación en conjunto con la adecuada
                    visión en 3D de la pelicula.
                </th>
                <th data-priority="33">
                    Verifique que no haya presencia de ruidos extraños en partes móviles y vibraciones fuertes durante
                    su funcionamiento o exceso de movimiento en las sillas.
                </th>
                <th data-priority="34">
                    Reiniciar un ciclo y accionar el botón de paro de emergencia (INVIO) en el teclado. La atracción
                    debe detenerse rápida y suavemente, luego desactive el paro e ingrese a estado manual para llevar
                    todo a punto cero.
                </th>
                <th data-priority="35">
                    Accione paro de emergencia y apague el computador y apague el breaker general y el compresor.
                </th>
                <th data-priority="36">
                    Realizar la anotación pertinente en la bitácora del equipo revisado,registrar: Fecha y hora de la
                    inspección, estado del equipo. (si puede o no abrir al público), Nombre legible, Firma y Cedula.
                </th>
                <th data-priority="37">
                    Observaciones
                </th>
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#example').DataTable({
                        ...
                        ajax: '{{ route('datatable.listaChequeoSimuladorFantasia') }}',
                        "columns": [{
                                data: 'nombre',
                            },
                            {
                            ...
                            {
                                data: 'chequeo_Uno_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Dos_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Tres_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Cuatro_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Cinco_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Seis_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Siete_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Ocho_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Nueve_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Diez_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Once_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Doce_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Trece_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Catorce_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Quince_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Dieciseis_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Diecisiete_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Dieciocho_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Diecinueve_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Veinte_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Ventiuno_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Ventidos_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Ventitres_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Venticuatro_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Venticinco_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Ventiseis_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Ventisiete_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Ventiocho_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Ventinueve_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Treinta_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Treintauno_Simulador_Fantasia'
                            },
                            {
                                data: 'chequeo_Treintados_Simulador_Fantasia'
                            },
                            {
                                data: 'observaciones'
                            },
        ...
        <script>
            function mostrarImagen(imagen) {
                $.ajax({
                    url: `/listaChequeoSimuladorFantasia/imagenes/${imagen}`,
                    type: 'GET',
