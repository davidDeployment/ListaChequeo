    ...
    <table id="example" class="stripe hover " style="padding-top: 1em;  padding-bottom: 1em;">
        <thead>
            <tr class="bg-slate-700 bg-opacity-100 text-white">
                ...
                <th data-priority="5">En el gabinete eléctrico verifique que deben estar encendidos los breakers general,
                    hidráulico, tomas y aire
                </th>
                <th data-priority="6">
                    Verificar y remover elementos extraños en la zona como escombros y basuras.
                </th>
                <th data-priority="7">
                    Verificar que el enfiladero esté anclado, firme, en buen estado, que no posean fisuras, corrosión ni
                    superficies cortantes</th>
                <th data-priority="8">Revisar que los reflectores del piso estén bien ancladas y no posean la guarda
                    quebrada, verificar que se en cuenten las dos cámaras ubicadas en cada ala y que estén en su
                    posición correcta. Revisar que los bombillos de las alas estén ajustados
                </th>
                <th data-priority="9">
                    Verificar que las escalas de entrada y salida estén bien ancladas, firmes en su sitio, en buen
                    estado, que no posean fisuras ni superficies cortantes ni corrosión y que el material o cintas
                    antideslizantes estén en buen estado.
                </th>
                <th data-priority="10">
                    Verificar visualmente el estado de las alas, los trenes de aterrizaje y el cuerpo del avión. Validar
                    que no hayan elementos fisurados ni con presencia de corrosión</th>
                <th data-priority="11">
                    Revisar que no hayan fugas de aceite en depósito de aceite y conexiones de manguera. Verificar en la
                    mirilla del tanque que el nivel sea el indicado, que las mangueras no estén dobladas o presionadas
                    con otros elementos.
                </th>
                <th data-priority="12">
                    Revisar que los cables de conexión de válvulas y motor estén conectados y organizados, verificar que
                    el motor posea la guarda del ventilador y gire sin problemas
                </th>
                <th data-priority="13">
                    Abrir puerta de la cabina y encender iluminación interna lateral y central
                </th>
                <th data-priority="14">
                    Sillas: están bien fijadas a la base, poseen las dos guardas de aluminio inferiores , las mesas
                    están fijas a las sillas, poseen el tapizado y espumas en buen estado, verificar que cada una posea
                    el cinturón de seguridad completo que este bien fijo a la silla y que funcione correctamente.
                </th>
                <th data-priority="15">
                    Verificar que las bases de las sillas se encuentren ancladas al piso que no posean fisuras o
                    corrosión, que posean las seis ruedas por base tipo polea y que giren libremente, que estén
                    acopladas al eje del sistema de movimiento, que la silla se encuentre bien posicionada sobre las
                    ruedas tipo polea. (las únicas sillas que no tienen base acoplada al sistema de movimiento son las
                    ultimas del primer pasillo).</th>
                <th data-priority="16">
                    Revisar que el tapete no se encuentre despegado o roto y que no haya presencia de hundimientos en el
                    piso</th>
                <th data-priority="17">
                    Revisar que todas los reflectores del piso ,luces de las alas, lámparas internas laterales y
                    centrales y luces cabina funcionen correctamente</th>
                <th data-priority="18">
                    Revisar que las dos bases de los actuadores hidráulicos estén bien anclados a la estructura del
                    avión, que no posean fisuras ni corrosión, que los pasadores de cada actuador no se encuentren
                    torcidos o deformes, que los actuadores no presenten fugas en la entrada de las mangueras o en sus
                    retenedores.
                </th>
                <th data-priority="19">
                    Verificar que las puertas de entrada y salida no se encuentre pegadas ni presenten ruido al moverla
                    y no posea corrosión</th>
                <th data-priority="20">
                    Revisar que no hayan señal de humedad o gotas en el interior</th>
                <th data-priority="21">
                    Revisar sujeción de guardas del sistema motriz
                </th>
                <th data-priority="22">
                    Verificar que en los 4 aires acondicionados no hayan fugas de aire, verificar anclaje y conexiones
                    eléctricas en cada uno. Encender y estar atento a que enfríen los sistemas de refrigeración
                </th>
                <th data-priority="23">
                    Verifique que los tres amplificadores de audio estén funcionando</th>
                <th data-priority="24">
                    Revisar que los dos productores de audio y video tengan incrustada la memoria y que posean las tres
                    conexiones de control y poder</th>
                <th data-priority="25">
                    Verifique que los 2 tableros de potencia y control estén limpios y que no hayan elementos extraños,
                    suciedad, insectos o desechos de estos en su interior</th>
                <th data-priority="26">
                    Verifique que los elementos eléctricos estén completos y en buen estado.</th>
                <th data-priority="27">
                    Verifique que los cables estén conectados correctamente en sus respectivas borneras, ordenados y
                    protegidos por canaletas.
                </th>
                <th data-priority="28">
                    Verifique que no haya evidencia de cortos, cintas aislantes sueltas, o indicios de recalentamiento
                    en los componentes del tablero.</th>
                <th data-priority="29">
                    Verificar que los amplificadores estén prendidos, revisar que todas las pantallas estén prendidas y
                    se visualice el exterior del avión según la posición de las dos cámaras, de lo contrario configurar
                    las pantallas que se necesiten con el control remoto.</th>
                <th data-priority="30">
                    Se debe accionar el pulsador de “Reset”, ( botón rojo ubicado al frente de los amplificadores de
                    audio y video) que indica que el sistema está listo para operar.
                </th>
                <th data-priority="31">
                    Simultáneamente, debe arrancar los reproductores y comenzar el sistema audio a dar la introducción e
                    indicaciones a sequir a los usuarios, verifique que todos los bafles y subwoofer funcionen y que el
                    sonido sea de alta fidelidad</th>
                <th data-priority="32">
                    Cuando en el sonido se indique el despeque del avión, verificar que se haga en todas las pantallas
                    el cambio de video de al de el reproductor y que la imagen sea nítida.
                </th>
                <th data-priority="33">
                    Verificar que el movimiento de las sillas esté sincronizado con el audio y video.</th>
                <th data-priority="34">
                    Verificar que no se presenten ruidos extraños en el sistema hidráulico, y demás partes móviles de la
                    atracción, este atento a vibraciones fuertes durante su funcionamiento. </th>
                <th data-priority="35">
                    Cuando se termine la reproducción, automáticamente se deben parar las sillas, apagar el sonido y el
                    video hacer el cambio al de visualizar la parte de afuera. </th>
                <th data-priority="36">
                    Apagar el sistema hidráulico del pulsador rojo y todas las luces</th>
                <th data-priority="37">
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#example').DataTable({
                        ...
                        ajax: '{{ route('datatable.listaChequeoAvion') }}',
                        "columns": [{
                                data: 'nombre',
                            },
                            {
                            ...
                            {
                                data: 'chequeo_Uno_Avion'
                            },
                            {
                                data: 'chequeo_Dos_Avion'
                            },
                            {
                                data: 'chequeo_Tres_Avion'
                            },
                            {
                                data: 'chequeo_Cuatro_Avion'
                            },
                            {
                                data: 'chequeo_Cinco_Avion'
                            },
                            {
                                data: 'chequeo_Seis_Avion'
                            },
                            {
                                data: 'chequeo_Siete_Avion'
                            },
                            {
                                data: 'chequeo_Ocho_Avion'
                            },
                            {
                                data: 'chequeo_Nueve_Avion'
                            },
                            {
                                data: 'chequeo_Diez_Avion'
                            },
                            {
                                data: 'chequeo_Once_Avion'
                            },
                            {
                                data: 'chequeo_Doce_Avion'
                            },
                            {
                                data: 'chequeo_Trece_Avion'
                            },
                            {
                                data: 'chequeo_Catorce_Avion'
                            },
                            {
                                data: 'chequeo_Quince_Avion'
                            },
                            {
                                data: 'chequeo_Dieciseis_Avion'
                            },
                            {
                                data: 'chequeo_Diecisiete_Avion'
                            },
                            {
                                data: 'chequeo_Dieciocho_Avion'
                            },
                            {
                                data: 'chequeo_Diecinueve_Avion'
                            },
                            {
                                data: 'chequeo_Veinte_Avion'
                            },
                            {
                                data: 'chequeo_Ventiuno_Avion'
                            },
                            {
                                data: 'chequeo_Ventidos_Avion'
                            },
                            {
                                data: 'chequeo_Ventitres_Avion'
                            },
                            {
                                data: 'chequeo_Venticuatro_Avion'
                            },
                            {
                                data: 'chequeo_Venticinco_Avion'
                            },
                            {
                                data: 'chequeo_Ventiseis_Avion'
                            },
                            {
                                data: 'chequeo_Ventisiete_Avion'
                            },
                            {
                                data: 'chequeo_Ventiocho_Avion'
                            },
                            {
                                data: 'chequeo_Ventinueve_Avion'
                            },
                            {
                                data: 'chequeo_Treinta_Avion'
                            },
                            {
                                data: 'chequeo_Treintauno_Avion'
                            },
                            {
                                data: 'chequeo_Treintados_Avion'
                            },
                            {
                                data: 'chequeo_Treintatres_Avion'
                            },
                            {
                                data: 'observaciones'
                            },
        ...
        <script>
            function mostrarImagen(imagen) {
                $.ajax({
                    url: `/listaChequeoAvion/imagenes/${imagen}`,
                    type: 'GET',
