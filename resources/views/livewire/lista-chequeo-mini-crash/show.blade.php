    ...
    <table id="example" class="stripe hover " style="padding-top: 1em;  padding-bottom: 1em;">
        <thead>
            <tr class="bg-slate-700 bg-opacity-100 text-white">
                ...
                <th>
                    En el gabinete de potencia verifique antes de iniciar la revisión que el interruptor general este en posición de apagado. Luego encienda la atracción para operar los vehículos 
                </th>
                <th>
                    Verificar la ausencia de elementos extraños en la zona, escombros.
                </th>
                <th>
                ...
                <th>
                    Verificar que los cerramientos estén correctamente ubicados, firmes en su sitio y que no posean superficies cortante ni corrosión.
                </th>
                <th>
                    Verificar el piso de los alrededores en busca de pines o elementos que puedan pertenecer al equipo, si encuentra alguno, cerciórese que no pertenezca al equipo e informe a los revisores de equipos próximos para descartar que no falte en uno de ellos.
                </th>
                <th>
                    Realizar inspección en la estructura del techo y la cenefa la cual no puede tener oxidación ni deformación
                </th>
                <th>
                    Verificar que la malla se encuentre tensionada correctamente y con los tensores completos ubicados de manera adecuada
                </th>
                <th>
                    Verificar que los pines de la estructura cuenten con los pasadores que se debe usar por norma y que la ubicación de estos sea la correcta
                </th>
                <th>
                    Inspeccionar que la estructura de la cenefa se encuentre bien posicionada y la pintura en buen estado
                </th>
                <th>
                    Verificar que la cubierta del techo en la atracción esté en buen estado, no presente luces o aberturas que puedan generar filtraciones de agua. 
                </th>
                <th>
                    Revise que esté correctamente fijada a la estructura soporte.
                </th>
                <th>
                    Las láminas del piso deben estar niveladas, no poseer grietas por desgaste y sus juntas no presentan una apertura superior a 5 mm.
                </th>
                <th>
                    Verifique que las cubiertas de las columnas de soporte estén fijados firmemente
                </th>
                <th>
                    Verifique que los parachoques perimetrales de la pista estén bien posicionados y ajustados , en buen estado tanto físico como estético
                </th>
                <th>
                    Verificar que la pista no posea sustancias que impidan la conductividad eléctrica con la rueda metálica del carro 
                </th>
                <th>
                    Verificar que en la entrada y salida de la pista haya cinta antideslizante que evite incidentes al terminar cada turno 
                </th>
                <th>
                    Verificar la presión de aire en el parachoques. El parachoques debe estar en buen estado, sin desgastes excesivos en su superficie.  
                </th>
                <th>
                    Verificar el correcto estado de los cinturones de seguridad 2 por cada carro y sus protectores
                </th>
                <th>
                    Verificar el buen estado de las láminas de acrílico y las luces 
                </th>
                <th>
                    Verificar que el conjunto de tubo y trole estén en buen estado, además que la varilla chipa no esté desgastada. El resorte debe garantizar el contacto trole-malla, y no debe estar deformado.
                </th>
                <th>
                    Verificar que la espuma y tapizado de los asientos se encuentre en buen estado. 
                </th>
                <th>
                    Verificar que no se encuentren cables sueltos al interior de los carros ni elementos extraños
                </th>
                <th>
                    Verificar el buen estado de la chapa de seguridad y abra los tablero
                </th>
                <th>
                    Verificar la impermeabilidad de los tableros.
                </th>
                <th>
                    Verificar que los tableros de potencia estén limpios y que no hayan elementos extraños, suciedad, insectos o desechos de estos en su interior. 
                </th>
                <th>
                    Verificar que los elementos eléctricos estén completos y en buen estado.
                </th>
                <th>
                    Verificar que los cables estén conectados correctamente en sus respectivas borneras, ordenados y protegidos por canaletas. 
                </th>
                <th>
                    Verificar que no haya evidencia de cortos, cintas aislantes sueltas, o indicios de recalentamiento en los componentes del tablero.
                </th>
                <th>
                    Verificar que esté firme en su sitio.
                </th>
                <th>
                    Verificar el correcto estado de los pulsadores y mandos del tablero.
                </th>
                <th>
                    Se dirige al tablero de Potencia, acciona el interruptor principal y los breakers restantes de control e iluminación.
                </th>
                <th>
                    Verificar los voltajes entre fases haciendo uso del selector dispuesto para tal fin. Con esto se identifica que las tres fases necesarias para el funcionamiento de la atracción, estén disponibles en el tablero.
                </th>
                <th>
                    V RN
                </th>
                ...
                <th>
                    Verificar que los ventiladores del tablero de potencia estén funcionando; especialmente el ventilador del rectificador.
                </th>
                <th>
                    En el tablero de control se abre el interruptor tipo llave y se desactiva la emergencia. 
                </th>
                <th>
                    En el tablero de control, verificar el correcto funcionamiento de los pulsadores y codillos dispuestos para el accionamiento de la atracción. 
                </th>
                <th>
                    Verificar que todas las luces de la atracción enciendan, incluyendo luces piloto, techo, columnas, luces delanteras y traseras de cada vehículo y manguera exterior
                </th>
                <th>
                    Verificar que el temporizador este en 3 minutos y que se apague cumplido el tiempo. 
                </th>
                <th>
                    Dar encendido a la pista del pulsador verde, verificar si las luces de los carros se accionaron y que no hayan carros directos
                </th>
                <th>
                    En el tablero de potencia verifique el medidor de voltaje de salida, este debe marcar 75 voltios con los vehículos en reposo. Registre el voltaje observado
                </th>
                <th>
                    Pruebe cada carro, Verifique que el pedal funcione correctamente y al accionarlo el carro se ponga en movimiento que no se presenten ruidos extraños , este atento a vibraciones fuertes durante su funcionamiento y que la volante sea suave y maniobrable, la velocidad real debe corresponder con la ajustada en el gabinete de potencia. En caso de encontrar ruido o mal funcionamiento voltear carro y revisar anormalidad para programar correctivo inmediato
                </th>
                <th>
                    Verificar que al accionar la emergencia se desactive la pista y paren todos los carros.
                </th>
                <th>
                    Pare la atracción haciendo uso del pulsador rojo (paro), deje accionado el botón de emergencia, gire y retire la llave, no desenergize los tableros, recuerde dejar los tableros de potencia asegurados y cerrados con llave. 
                </th>
                <th>
                ...
                <th>
                    Observaciones o comentarios durante la revisión
                </th>
                <th>
                    Imagen
                </th>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
           ...
           $(document).ready(function() {
               ...
               var table = $('#example').DataTable({
                   "processing": true,
                       ...
                       ajax: '{{ route('datatable.listarChequeoMiniCrash') }}',
                       "columns": [{
                               data: 'nombre',
                           },
                           {
                           ...
                           {
                               data: 'chequeo_Uno_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Dos_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Tres_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Cuatro_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Cinco_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Seis_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Siete_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Ocho_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Nueve_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Diez_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Once_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Doce_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Trece_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Catorce_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Quince_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Dieciseis_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Diecisiete_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Dieciocho_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Diecinueve_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Veinte_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Ventiuno_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Ventidos_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Ventitres_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Venticuatro_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Venticinco_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Ventiseis_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Ventisiete_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Ventiocho_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Ventinueve_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Treinta_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Treintauno_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Treintados_Mini_Crash'
                           },
                           {
                               data: 'VRN'
                           },
                           ...
                           {
                               data: 'chequeo_Treintatres_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Treintacuatro_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Treintacinco_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Treintaseis_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Treintasiete_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Treintaocho_Mini_Crash'
                           },
                           {
                               data: 'tablero_potencia_voltaje'
                           },
                           {
                               data: 'chequeo_Treintanueve_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Cuarenta_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Cuarentauno_Mini_Crash'
                           },
                           {
                               data: 'chequeo_Cuarentados_Mini_Crash'
                           },
                           {
                               data: 'observaciones'
                           },
       ...
       <script>
           function mostrarImagen(imagen) {
               $.ajax({
                   url: `/listaChequeoMiniCrash/imagenes/${imagen}`,
                   type: 'GET',
