    ...
    <table id="example" class="stripe hover " style="padding-top: 1em;  padding-bottom: 1em;">
        <thead>
            <tr class="bg-slate-700 bg-opacity-100 text-white">
                ...
                <th>
                    Revisar que el equipo se encuentre apagado
                </th>
                <th>
                ...
                <th>
                    Verificar que los cerramientos estén correctamente ubicados, firmes en su sitio y que no posean
                    superficies cortante ni corrosión.
                </th>
                <th>
                    Verifique el piso de los alrededores en busca de pines o elementos que puedan pertenecer al equipo,
                    si encuentra alguno, cerciórese que no pertenezca al equipo e informe inmediatamente
                </th>
                <th>
                    Verificar que estén correctamente posicionados los apoyos de madera dando nivelación a la
                    estructura. Estos deben estar en buen estado
                </th>
                <th>
                    Verificar las estructuras del soporte principal, los brazos y las naves, deben estar libres de
                    oxidación y fisuras
                </th>
                <th>
                    Revisar la debida lubricación en las partes móviles de la estructura.
                </th>
                <th>
                    Verifique que las bases y perfiles estructurales no estén oxidados y no evidencien fisuras.
                </th>
                <th>
                    Inspeccione que no hayan deformaciones en los soportes de las unidades de pasajeros a los brazos de
                    la atracción.
                </th>
                <th>
                    Verificar el estado de la estructura de cada nave, la fibra de vidrio debe estar sin superficies
                    cortantes ni fisuras, la pintura en buen estado. Revisar por debajo de la nave el apoyo con el eje
                    de sujeción que esté y que la nave esté nivelada
                </th>
                <th>
                    Revisar el estribo o escala de acceso a la nave verificando el buen estado de las barras o platinas
                    de piso.
                </th>
                <th>
                    Verificar los asientos de las naves que estén fijas a la estructura, sin cortes ni grietas.
                </th>
                <th>
                    Verificar cada cinturón de seguridad, estos deben permanecer siempre en buen estado, y fijo a la
                    fibra de vidrio.
                </th>
                <th>
                    Revisar estado y posición de las palancas y botones actuadores de las naves, deben estar en modo
                    funcional.
                </th>
                <th>
                    Verificar el estado de las laminas del piso, estas deben estar remachadas fijas al piso.
                </th>
                <th>
                    Verificar los volantes, estos debe estar bien posicionados, su tornillería completa y libres de
                    superficies cortantes
                </th>
                <th>
                    Revisar que la marcación del torque de las tapas de los cilindros neumáticos coincidad
                </th>
                <th>
                    Verificar que las acometidas eléctricas al motor estén correctamente ubicadas y aisladas, no
                    encender el equipo si encuentra cables zafados o sin recubrimiento, no encienda el equipo hasta que
                    haya sido corregida la novedad.
                </th>
                <th>
                    Revisar que el motor y el reductor estén debidamente fijados a su base, su acople alineado y en buen
                    estado y no hayan fisuras en la estructura de apoyo
                </th>
                <th>
                    Verificar que no hayan fugas de aceite en el reductor
                </th>
                <th>
                    Verificar la lubricación de la catalina y el piñón, que la grasa sea suficiente y haya una película
                    lubricante uniforme en los dientes
                </th>
                <th>
                    Verifique que no hayan fugas de aceite en el compresor y en caso de existir reportarlas
                    inmediatamente. Revisar nivel de aceite.
                </th>
                <th>
                    Verifique que haya una adecuada ventilación del compresor y no estén tapadas las salidas y entradas
                    del aire. Revisar nivel de aceite del compresor
                </th>
                <th>
                    Anotar las horas de operación del compresor
                </th>
                <th>
                    Revisar nivel de aceite del compresor y en caso de ajustar, utilizar lubricante Ingersollrand Ultra
                    Coolant
                </th>
                <th>
                    Verificar el buen estado de la chapa de seguridad y abra el tablero.
                </th>
                <th>
                    Verificar la impermeabilidad de los tableros.
                </th>
                <th>
                    Verificar que los tableros de potencia estén limpios y que no hayan elementos extraños y ajenos a su
                    función, suciedad, insectos o desechos de estos en su interior.
                </th>
                <th>
                    Verificar que los elementos eléctricos estén completos y en buen estado
                </th>
                <th>
                    Verificar que los cables estén conectados correctamente en sus respectivas borneras, ordenados y
                    protegidos por canaletas.
                </th>
                <th>
                    Verificar que no haya evidencia de cortos, cintas aislantes sueltas, o indicios de recalentamiento
                    en los componentes del tablero.
                </th>
                <th>
                    Verificar que este firme en su sitio.
                </th>
                <th>
                    Verifique el correcto estado de los pulsadores y mandos del tablero.
                </th>
                <th>
                    Verificar los voltajes entre fases haciendo uso del selector dispuesto para tal fin
                </th>
                <th>
                    En el tablero de control gire la llave de swiche para activar el sistema de control y desenclave el
                    botón de paro de emergencia.
                </th>
                <th>
                    Verifique el nivel de aceite de la unidad de mantenimiento y la posición del regulador de goteo e
                    aceite.
                </th>
                <th>
                    Verifique el estado de las electroválvulas, cilindros neumáticos y conexiones en busca de fugas o
                ...
                <th>
                    Ponga en marcha la atracción haciendo uso del botón ARRANQUE (verde).

                </th>
                <th>
                    Verifique que las naves ascienden con el accionamiento de la perilla en el tablero de control
                </th>
                <th>
                    ...
                    (si puede o no abrirse al público), Nombre legible, Firma , Cedula.
                </th>
                <th>
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#example').DataTable({
                        ...
                        ajax: '{{ route('datatable.listaChequeoInvasion') }}',
                        "columns": [{
                                data: 'nombre',
                            },
                            {
                            ...
                            {
                                data: 'chequeo_Uno_Invasion'
                            },
                            {
                                data: 'chequeo_Dos_Invasion'
                            },
                            {
                                data: 'chequeo_Tres_Invasion'
                            },
                            {
                                data: 'chequeo_Cuatro_Invasion'
                            },
                            {
                                data: 'chequeo_Cinco_Invasion'
                            },
                            {
                                data: 'chequeo_Seis_Invasion'
                            },
                            {
                                data: 'chequeo_Siete_Invasion'
                            },
                            {
                                data: 'chequeo_Ocho_Invasion'
                            },
                            {
                                data: 'chequeo_Nueve_Invasion'
                            },
                            {
                                data: 'chequeo_Diez_Invasion'
                            },
                            {
                                data: 'chequeo_Once_Invasion'
                            },
                            {
                                data: 'chequeo_Doce_Invasion'
                            },
                            {
                                data: 'chequeo_Trece_Invasion'
                            },
                            {
                                data: 'chequeo_Catorce_Invasion'
                            },
                            {
                                data: 'chequeo_Quince_Invasion'
                            },
                            {
                                data: 'chequeo_Dieciseis_Invasion'
                            },
                            {
                                data: 'chequeo_Diecisiete_Invasion'
                            },
                            {
                                data: 'chequeo_Dieciocho_Invasion'
                            },
                            {
                                data: 'chequeo_Diecinueve_Invasion'
                            },
                            {
                                data: 'chequeo_Veinte_Invasion'
                            },
                            {
                                data: 'chequeo_Ventiuno_Invasion'
                            },
                            {
                                data: 'chequeo_Ventidos_Invasion'
                            },
                            {
                                data: 'chequeo_Ventitres_Invasion'
                            },
                            {
                                data: 'chequeo_Venticuatro_Invasion'
                            },
                            {
                                data: 'hora_operacion_tablero'
                            },
                            {
                                data: 'chequeo_Venticinco_Invasion'
                            },
                            {
                                data: 'chequeo_Ventiseis_Invasion'
                            },
                            {
                                data: 'chequeo_Ventisiete_Invasion'
                            },
                            {
                                data: 'chequeo_Ventiocho_Invasion'
                            },
                            {
                                data: 'chequeo_Ventinueve_Invasion'
                            },
                            {
                                data: 'chequeo_Treinta_Invasion'
                            },
                            {
                                data: 'chequeo_Treintauno_Invasion'
                            },
                            {
                                data: 'chequeo_Treintados_Invasion'
                            },
                            {
                                data: 'chequeo_Treintatres_Invasion'
                            },
                            {
                                data: 'verificar_voltaje_selector'
                            },
                            {
                                data: 'chequeo_Treintacuatro_Invasion'
                            },
                            {
                                data: 'chequeo_Treintacinco_Invasion'
                            },
                            {
                                data: 'chequeo_Treintaseis_Invasion'
                            },
                            {
                                data: 'chequeo_Treintasiete_Invasion'
                            },
                            {
                                data: 'chequeo_Treintaocho_Invasion'
                            },
                            {
                                data: 'chequeo_Treintanueve_Invasion'
                            },
                            {
                                data: 'chequeo_Cuarenta_Invasion'
                            },
                            {
                                data: 'observaciones'
                            },
        ...
        <script>
            function mostrarImagen(imagen) {
                $.ajax({
                    url: `/listaChequeoInvasion/imagenes/${imagen}`,
                    type: 'GET',
