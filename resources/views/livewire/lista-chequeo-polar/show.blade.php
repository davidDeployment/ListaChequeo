    ...
    <table id="example" class="stripe hover " style="padding-top: 1em;  padding-bottom: 1em;">
        <thead>
            <tr class="bg-slate-700 bg-opacity-100 text-white">
                ...
                <th data-priority="5">Verificar la ausencia de elementos extraños en la zona, escombros, basuras.
                <th data-priority="6">
                ...
                <th data-priority="7">
                    ...
                    superficies cortante ni corrosión.</th>
                <th data-priority="8"> Verifique que el soporte de los costales este fijo y anclado firme en su sitio
                </th>
                <th data-priority="9">
                    Verifique que la banda antideslizante este en buen estado, fija al piso y sin irregularidades que
                    puedan generar tropiezos.
                </th>
                <th data-priority="10">
                    Verifique las laminas del piso de la rampa, estas debe estar completas y en buen estado, con todos
                    sus remaches y firme a la estructura </th>
                <th data-priority="11">
                    Inspeccionar el buen estado de los pasamanos, deben estar firmes en su sitio y no deben tener
                    superficies cortantes.
                </th>
                <th data-priority="12">
                    Revisar que la estructura de soporte del letrero de la atracción este correctamente anclada, firme
                    en su sitio y libre de corrosión.
                </th>
                <th data-priority="13">
                    Verificar que los pasadores tipo Beta estén ubicados correctamente en los pines de la estructura
                </th>
                <th data-priority="14">
                    Verificar que los bloques de madera de apoyo en los marcos estén en buenas condiciones
                </th>
                <th data-priority="15">
                    Verificar que los pines estén ajustados a la estructura y no tengan corrosión
                </th>
                <th data-priority="16">
                    Verificar que las superficies de los deslizaderos estén completas, sin fisuras o superficies corto
                    pulsantes.</th>
                <th data-priority="17">
                    Revisar que la pintura se conserve en buen estado, la atracción debe conservar una buena apariencia
                    estética.</th>
                <th data-priority="18">
                    Revisar estado de las juntas y uniones de la fibra de vidrio, garantizando la ausencia de fisuras o
                    defectos en la superficie que generen un riesgo para el usuario
                </th>
                <th data-priority="19">
                    Revisar estado de la pintura y estructura en la plataforma de llegada, donde no deben haber fisuras
                    ni desprendimientos de pintura</th>
                <th data-priority="20">
                    Revisar el estado de la fibra del tobogán por debajo de la estructura, la cual no debe tener
                    presencia de humedad ni debe haber desgaste
                </th>
                <th data-priority="21">
                    Revisar que la colchoneta se encuentre en buen estado
                </th>
                <th data-priority="22">
                    Verificar que todos los reflectores de la atracción enciendan
                </th>
                <th data-priority="23">
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('#example').DataTable({
                    "processing": true,
                        ...
                        ajax: '{{ route('datatable.listaChequeoPolar') }}',
                        "columns": [{
                                data: 'nombre',
                            },
                            {
                            ...
                            {
                                data: 'chequeo_Uno_Polar'
                            },
                            {
                                data: 'chequeo_Dos_Polar'
                            },
                            {
                                data: 'chequeo_Tres_Polar'
                            },
                            {
                                data: 'chequeo_Cuatro_Polar'
                            },
                            {
                                data: 'chequeo_Cinco_Polar'
                            },
                            {
                                data: 'chequeo_Seis_Polar'
                            },
                            {
                                data: 'chequeo_Siete_Polar'
                            },
                            {
                                data: 'chequeo_Ocho_Polar'
                            },
                            {
                                data: 'chequeo_Nueve_Polar'
                            },
                            {
                                data: 'chequeo_Diez_Polar'
                            },
                            {
                                data: 'chequeo_Once_Polar'
                            },
                            {
                                data: 'chequeo_Doce_Polar'
                            },
                            {
                                data: 'chequeo_Trece_Polar'
                            },
                            {
                                data: 'chequeo_Catorce_Polar'
                            },
                            {
                                data: 'chequeo_Quince_Polar'
                            },
                            {
                                data: 'chequeo_Dieciseis_Polar'
                            },
                            {
                                data: 'chequeo_Diecisiete_Polar'
                            },
                            {
                                data: 'chequeo_Dieciocho_Polar'
                            },
                            {
                                data: 'chequeo_Diecinueve_Polar'
                            },
                            {
                                data: 'observaciones'
                            },
         ...
         <script>
            function mostrarImagen(imagen) {
                ...
                $.ajax({
                    url: `/listaChequeoPolar/imagenes/${imagen}`,
                    type: 'GET',
