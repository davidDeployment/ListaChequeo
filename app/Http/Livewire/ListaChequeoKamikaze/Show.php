...
class Show extends Component
{
    ...
    {
        return view('livewire.lista-chequeo-kamikaze.show');
    }

    public function listaChequeoKamikaze()
    {
        $listaChequeo = ListaChequeoKamikaze::select(
            'lista_chequeo_kamikazes.*',
            'users.name as nombre'
        )->join('users', 'users.id', '=', 'lista_chequeo_kamikazes.user_id')->get();
    ...
    public function imagen(ListaChequeoKamikaze $listaChequeoKamikaze)
    {
        return $listaChequeoKamikaze->imagen;
    }
}
