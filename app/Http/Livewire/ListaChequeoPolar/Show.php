...
class Show extends Component
{
    ...
    {
        return view('livewire.lista-chequeo-polar.show');
    }

    public function listaChequeoPolar()
    {
        $listaChequeo = ListaChequeoPolar::select(
            'lista_chequeo_polars.*',
            'users.name as nombre'
        )->join('users', 'users.id', '=', 'lista_chequeo_polars.user_id')->get();
    ...
    public function imagen(ListaChequeoPolar $listaChequeoPolar)
    {
        return $listaChequeoPolar->imagen;
    }
}
