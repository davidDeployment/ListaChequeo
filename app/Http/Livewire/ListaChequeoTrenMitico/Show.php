...
class Show extends Component
{
    ...
    {
        return view('livewire.lista-chequeo-tren-mitico.show');
    }

    public function listarChequeoTrenMitico()
    {
        $listaChequeo = ListaChequeoTrenMitico::select(
            'lista_chequeo_tren_miticos.*',
            'users.name as nombre'
        )->join('users', 'users.id', '=', 'lista_chequeo_tren_miticos.user_id')->get();
    ...
    public function imagen(ListaChequeoTrenMitico $listaChequeoTrenMitico)
    {
        return $listaChequeoTrenMitico->imagen;
    }
}
