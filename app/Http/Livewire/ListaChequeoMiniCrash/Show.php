...
class Show extends Component
{
    ...
    {
        return view('livewire.lista-chequeo-mini-crash.show');
    }

    public function listarChequeoMiniCrash()
    {
        $listaChequeo = ListaChequeoMiniCrash::select(
            'lista_chequeo_mini_crashes.*',
            'users.name as nombre'
        )->join('users', 'users.id', '=', 'lista_chequeo_mini_crashes.user_id')->get();
    ...
    public function imagen(ListaChequeoMiniCrash $listaChequeoMiniCrash)
    {
        return $listaChequeoMiniCrash->imagen;
    }
}
