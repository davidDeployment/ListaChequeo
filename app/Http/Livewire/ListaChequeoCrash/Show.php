...
class Show extends Component
{
    ...
    {
        return view('livewire.lista-chequeo-crash.show');
    }

    public function listaChequeoCrash()
    {
        $listaChequeo = ListaChequeoCrash::select(
            'lista_chequeo_crashes.*',
            'users.name as nombre'
        )->join('users', 'users.id', '=', 'lista_chequeo_crashes.user_id')->get();
    ...
    public function imagen(ListaChequeoCrash $listaChequeoCrash)
    {
        return $listaChequeoCrash->imagen;
    }
}
